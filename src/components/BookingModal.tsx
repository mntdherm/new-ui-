        ...
        <div className="border-b p-4">
          ...
          <div className="flex items-center mt-4">
            ...
            <div className={`flex items-center transition-colors duration-200
              ${currentStep === 'date' ? 'text-blue-600' : 'text-gray-500'}`}>
            ...
            {/* Time Step */}
            <div className={`flex items-center transition-colors duration-200
              ${currentStep === 'time' ? 'text-blue-600' : 'text-gray-500'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2
                transition-all duration-200
                ${currentStep === 'time' 
                  ? 'border-blue-600 bg-blue-50 scale-110' 
            ...
            {!currentUser && (
              <>
                <div className={`flex items-center transition-colors duration-200
                  ${currentStep === 'signup' ? 'text-blue-600' : 'text-gray-500'}`}>
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2
                    transition-all duration-200
                    ${currentStep === 'signup' 
                      ? 'border-blue-600 bg-blue-50 scale-110' 
            ...
            {/* Confirm Step */}
            <div className={`flex items-center transition-colors duration-200
              ${currentStep === 'confirm' ? 'text-blue-600' : 'text-gray-500'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2
                transition-all duration-200
                ${currentStep === 'confirm' 
                  ? 'border-blue-600 bg-blue-50 scale-110' 
                ...
                >
                  {loading ? (
                    <>
                      ...
                      <span className="animate-pulse">Varataan...</span>
                    </>
                  ) : (
                    <>
